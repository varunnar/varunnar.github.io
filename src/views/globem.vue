<template>
        ...
        <template #extra-section>
          <div class="graph_explanation">
            ...
            <ul>
              ...
              <li>Hover over the graph—each line shows a student's mental health journey throughout the quarter.</li>
  ...
  export default {
    name: 'Note-book',
    components: { overLappingButton, ReflectionItem },
    data() {
      return {
        clicked: false,
      }
